...
def ConsultarRec():
    ...
    ConsultaRec = "SELECT recuperandas, cnpj, exposicao, dataagc, rjextinta FROM dados_rj"
...
relrec = ttk.Treeview(columns= ("coluna 1", "coluna 2", "coluna 3", "coluna 4", "coluna 5"))
